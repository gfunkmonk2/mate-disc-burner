...
static gboolean
rejilla_multi_DND_row_draggable (EggTreeMultiDragSource *drag_source,
				 GList *path_list)
{
	GList *iter;
...
static gboolean
rejilla_multi_DND_drag_data_get (EggTreeMultiDragSource *drag_source, 
				 GList *path_list, 
...
static gboolean
rejilla_multi_DND_drag_data_delete (EggTreeMultiDragSource *drag_source,
				    GList *path_list)
{
	return TRUE;
}
...
static void
rejilla_multi_DND_drag_source_init (EggTreeMultiDragSourceIface *iface)
{
	iface->row_draggable = rejilla_multi_DND_row_draggable;
	iface->drag_data_get = rejilla_multi_DND_drag_data_get;
	iface->drag_data_delete = rejilla_multi_DND_drag_data_delete;
}

static const GInterfaceInfo multi_DND_drag_source_info = {
	(GInterfaceInitFunc) rejilla_multi_DND_drag_source_init,
	NULL,
	NULL
};

static gboolean
rejilla_data_track_cfg_multi_DND_row_draggable (EggTreeMultiDragSource *drag_source,
						GList *path_list)
{
	GList *iter;
...
static gboolean
rejilla_data_track_cfg_multi_DND_drag_data_get (EggTreeMultiDragSource *drag_source,
						GList *path_list,
						GtkSelectionData *selection_data)
{
...
static gboolean
rejilla_data_track_cfg_multi_DND_drag_data_delete (EggTreeMultiDragSource *drag_source,
						   GList *path_list)
{
...
static void
rejilla_data_track_cfg_multi_DND_drag_source_init (EggTreeMultiDragSourceIface *iface)
{
	iface->row_draggable = rejilla_data_track_cfg_multi_DND_row_draggable;
	iface->drag_data_get = rejilla_data_track_cfg_multi_DND_drag_data_get;
	iface->drag_data_delete = rejilla_data_track_cfg_multi_DND_drag_data_delete;
}

static const GInterfaceInfo rejilla_data_track_cfg_multi_DND_drag_source_info = {
	(GInterfaceInitFunc) rejilla_data_track_cfg_multi_DND_drag_source_init,
	NULL,
	NULL
};

gboolean
rejilla_enable_multi_DND_for_model_type (GType type)
{
...
rejilla_enable_multi_DND (void)
{
	...
	g_type_add_interface_static (GTK_TYPE_LIST_STORE,
				     EGG_TYPE_TREE_MULTI_DRAG_SOURCE,
				     &multi_DND_drag_source_info);
	g_type_add_interface_static (REJILLA_TYPE_TRACK_DATA_CFG,
				     EGG_TYPE_TREE_MULTI_DRAG_SOURCE,
				     &rejilla_data_track_cfg_multi_DND_drag_source_info);
}
