...
typedef struct _RejillaScsiStatusWrSpdDesc RejillaScsiStatusWrSpdDesc;

#if G_BYTE_ORDER == G_LITTLE_ENDIAN

struct _RejillaScsiStatusWrSpdDesc {
	uchar reserved0			:8;
...
struct _RejillaScsiStatusPage {
	...
	RejillaScsiStatusWrSpdDesc wr_spd_desc [0];		/* 32 */
};
...
typedef struct _RejillaScsiStatusPage RejillaScsiStatusPage;
