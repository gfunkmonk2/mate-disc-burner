...
typedef struct _RejillaScsiWritePage RejillaScsiWritePage;

typedef enum {
	REJILLA_SCSI_WRITE_PACKET_INC	= 0x00,
	REJILLA_SCSI_WRITE_TAO		= 0x01,
	REJILLA_SCSI_WRITE_SAO		= 0x02,
	REJILLA_SCSI_WRITE_RAW		= 0x03

	/* Reserved */
} RejillaScsiWriteMode;
